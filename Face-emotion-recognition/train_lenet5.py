...
from ipython_genutils.py3compat import _print_statement_sub
...
def train(nEpochs):
  ...
  for epoch in range(nEpochs):
    ...
    if epoch_acc > acc :
        ...
        print("model saveing ..")
        torch.save(network.state_dict(), '/media/disk3/yrq/contest/Face-emotion-recognition/model2.pth')
        torch.save(optimizer.state_dict(), '/media/disk3/yrq/contest/Face-emotion-recognition/optimizer2.pth')
    else:
        print("\n")
